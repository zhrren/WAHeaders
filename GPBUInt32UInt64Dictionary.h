...
+(id)dictionaryWithValues:(const unsigned long long*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned long long)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned)key;
-(void)setValue:(unsigned long long)value forKey:(unsigned)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned)key value:(unsigned long long*)value;
...
-(id)initWithValues:(const unsigned long long*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
