...
+(id)dictionaryWithValues:(const BOOL*)values forKeys:(const BOOL*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(BOOL)value forKey:(BOOL)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithValues:(const BOOL*)values forKeys:(const BOOL*)keys count:(unsigned)count;
-(id)init;
@end
