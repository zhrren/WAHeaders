...
+(id)dictionaryWithValues:(const unsigned long long*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned long long)value forKey:(unsigned long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned long long)key;
-(void)setValue:(unsigned long long)value forKey:(unsigned long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned long long)key value:(unsigned long long*)value;
...
-(id)initWithValues:(const unsigned long long*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
-(id)init;
@end
