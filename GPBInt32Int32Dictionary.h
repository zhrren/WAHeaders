...
+(id)dictionaryWithValues:(const int*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(int)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithValues:(const int*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
