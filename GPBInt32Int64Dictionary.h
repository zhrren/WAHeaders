...
+(id)dictionaryWithValues:(const long long*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(long long)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(long long)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(long long*)value;
...
-(id)initWithValues:(const long long*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
