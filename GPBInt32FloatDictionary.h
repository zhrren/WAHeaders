...
+(id)dictionaryWithValues:(const float*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(float)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(float)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(float*)value;
...
-(id)initWithValues:(const float*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
