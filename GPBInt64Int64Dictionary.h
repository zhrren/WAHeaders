...
+(id)dictionaryWithValues:(const long long*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(long long)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(long long)key;
-(void)setValue:(long long)value forKey:(long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(long long)key value:(long long*)value;
...
-(id)initWithValues:(const long long*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
