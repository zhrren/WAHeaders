...
+(id)dictionaryWithValues:(const BOOL*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(BOOL)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(BOOL)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(BOOL*)value;
...
-(id)initWithValues:(const BOOL*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
