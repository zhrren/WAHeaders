...
+(id)dictionaryWithValues:(const BOOL*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(BOOL)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned)key;
-(void)setValue:(BOOL)value forKey:(unsigned)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned)key value:(BOOL*)value;
...
-(id)initWithValues:(const BOOL*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
