...
+(id)dictionaryWithValues:(const long long*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(long long)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned)key;
-(void)setValue:(long long)value forKey:(unsigned)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned)key value:(long long*)value;
...
-(id)initWithValues:(const long long*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
