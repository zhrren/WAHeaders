...
+(id)dictionaryWithValues:(const unsigned long long*)values forKeys:(id*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned long long)value forKey:(id)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(id)key;
-(void)setValue:(unsigned long long)value forKey:(id)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(id)key value:(unsigned long long*)value;
...
-(id)initWithValues:(const unsigned long long*)values forKeys:(id*)keys count:(unsigned)count;
-(id)init;
@end
