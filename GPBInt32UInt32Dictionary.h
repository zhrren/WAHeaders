...
+(id)dictionaryWithValues:(const unsigned*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(unsigned)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(unsigned*)value;
...
-(id)initWithValues:(const unsigned*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
