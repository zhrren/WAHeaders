...
+(id)dictionaryWithValues:(const unsigned*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(long long)key;
-(void)setValue:(unsigned)value forKey:(long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(long long)key value:(unsigned*)value;
...
-(id)initWithValues:(const unsigned*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
