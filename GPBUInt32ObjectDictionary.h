...
+(id)dictionaryWithObjects:(const id*)objects forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithObject:(id)object forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithObjects:(const id*)objects forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
