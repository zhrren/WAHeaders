...
+(id)dictionaryWithValues:(const unsigned*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned)key;
-(void)setValue:(unsigned)value forKey:(unsigned)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned)key value:(unsigned*)value;
...
-(id)initWithValues:(const unsigned*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
