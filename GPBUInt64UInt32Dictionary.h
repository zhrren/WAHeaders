...
+(id)dictionaryWithValues:(const unsigned*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned)value forKey:(unsigned long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned long long)key;
-(void)setValue:(unsigned)value forKey:(unsigned long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned long long)key value:(unsigned*)value;
...
-(id)initWithValues:(const unsigned*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
-(id)init;
@end
