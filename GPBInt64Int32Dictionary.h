...
+(id)dictionaryWithValues:(const int*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(int)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithValues:(const int*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
