...
+(id)dictionaryWithValues:(const double*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(double)value forKey:(unsigned long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned long long)key;
-(void)setValue:(double)value forKey:(unsigned long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned long long)key value:(double*)value;
...
-(id)initWithValues:(const double*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
-(id)init;
@end
