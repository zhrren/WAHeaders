...
+(id)dictionaryWithValues:(const unsigned long long*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned long long)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(unsigned long long)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(unsigned long long*)value;
...
-(id)initWithValues:(const unsigned long long*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
