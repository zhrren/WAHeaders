...
+(id)dictionaryWithValues:(const unsigned long long*)values forKeys:(const BOOL*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(unsigned long long)value forKey:(BOOL)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(BOOL)key;
-(void)setValue:(unsigned long long)value forKey:(BOOL)key;
...
-(BOOL)valueForKey:(BOOL)key value:(unsigned long long*)value;
-(id)description;
-(unsigned)hash;
...
-(id)initWithValues:(const unsigned long long*)values forKeys:(const BOOL*)keys count:(unsigned)count;
-(id)init;
@end
