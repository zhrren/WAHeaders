...
+(id)dictionaryWithValues:(const long long*)values forKeys:(id*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(long long)value forKey:(id)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(id)key;
-(void)setValue:(long long)value forKey:(id)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(id)key value:(long long*)value;
...
-(id)initWithValues:(const long long*)values forKeys:(id*)keys count:(unsigned)count;
-(id)init;
@end
