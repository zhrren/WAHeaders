...
+(id)dictionaryWithValues:(const float*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(float)value forKey:(unsigned long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned long long)key;
-(void)setValue:(float)value forKey:(unsigned long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned long long)key value:(float*)value;
...
-(id)initWithValues:(const float*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
-(id)init;
@end
