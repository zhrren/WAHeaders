...
+(id)dictionaryWithValues:(const double*)values forKeys:(id*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(double)value forKey:(id)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(id)key;
-(void)setValue:(double)value forKey:(id)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(id)key value:(double*)value;
...
-(id)initWithValues:(const double*)values forKeys:(id*)keys count:(unsigned)count;
-(id)init;
@end
