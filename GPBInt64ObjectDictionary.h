...
+(id)dictionaryWithObjects:(const id*)objects forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithObject:(id)object forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithObjects:(const id*)objects forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
