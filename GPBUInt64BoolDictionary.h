...
+(id)dictionaryWithValues:(const BOOL*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(BOOL)value forKey:(unsigned long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned long long)key;
-(void)setValue:(BOOL)value forKey:(unsigned long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned long long)key value:(BOOL*)value;
...
-(id)initWithValues:(const BOOL*)values forKeys:(const unsigned long long*)keys count:(unsigned)count;
-(id)init;
@end
