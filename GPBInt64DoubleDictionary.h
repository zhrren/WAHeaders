...
+(id)dictionaryWithValues:(const double*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(double)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(long long)key;
-(void)setValue:(double)value forKey:(long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(long long)key value:(double*)value;
...
-(id)initWithValues:(const double*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
