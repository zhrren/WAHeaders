...
+(id)dictionaryWithValues:(const int*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(int)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
...
-(id)initWithValues:(const int*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
