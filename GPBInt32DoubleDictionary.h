...
+(id)dictionaryWithValues:(const double*)values forKeys:(const int*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(double)value forKey:(int)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(int)key;
-(void)setValue:(double)value forKey:(int)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(int)key value:(double*)value;
...
-(id)initWithValues:(const double*)values forKeys:(const int*)keys count:(unsigned)count;
-(id)init;
@end
