...
+(id)dictionaryWithValues:(const float*)values forKeys:(const unsigned*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(float)value forKey:(unsigned)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(unsigned)key;
-(void)setValue:(float)value forKey:(unsigned)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(unsigned)key value:(float*)value;
...
-(id)initWithValues:(const float*)values forKeys:(const unsigned*)keys count:(unsigned)count;
-(id)init;
@end
