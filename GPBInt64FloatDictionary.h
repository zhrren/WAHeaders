...
+(id)dictionaryWithValues:(const float*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(float)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(long long)key;
-(void)setValue:(float)value forKey:(long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(long long)key value:(float*)value;
...
-(id)initWithValues:(const float*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
