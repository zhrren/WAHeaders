...
+(id)dictionaryWithValues:(const BOOL*)values forKeys:(const long long*)keys count:(unsigned)count;
+(id)dictionaryWithValue:(BOOL)value forKey:(long long)key;
+(id)dictionary;
-(void)removeAll;
-(void)removeValueForKey:(long long)key;
-(void)setValue:(BOOL)value forKey:(long long)key;
-(void)addEntriesFromDictionary:(id)dictionary;
-(BOOL)valueForKey:(long long)key value:(BOOL*)value;
...
-(id)initWithValues:(const BOOL*)values forKeys:(const long long*)keys count:(unsigned)count;
-(id)init;
@end
